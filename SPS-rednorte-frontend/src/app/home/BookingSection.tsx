...
export function BookingSection({ onReserva, onUrgencia }: { onReserva?: () => void, onUrgencia?: () => void }) {
        ...
        <div className="flex-1 w-full">
          ...
          <div className="border border-gray-200 rounded-2xl p-6 md:p-8 bg-white shadow-sm space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              ...
              border border-[#e63946] text-sm text-[#e63946] font-bold hover:bg-[#e63946] hover:text-white
              transition">
                Urgencia 24/7
              </button>
            </div>
